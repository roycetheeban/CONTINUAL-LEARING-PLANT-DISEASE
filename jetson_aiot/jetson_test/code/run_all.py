...
STEPS = [
    ...
    ("5", "05_end_to_end_loop.py", "End-to-end cascade loop"),
    ("6", "06_power_thermal.py", "Power and thermal profiling"),
    ("7", "07_redeploy_gate.py", "Redeploy + conversion/deployment gates"),
]
